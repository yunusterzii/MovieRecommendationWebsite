...
function App() {
  ...
  return (
    <>
      <Routes>
        <Route exact path="/" element={<HomePage isLoading={isLoading} setLoading={setLoading} movies={movies} searchMovies={searchMovies} rates={rates} randomMovies={randomMovies} setRandomMovies={setRandomMovies} />}/>
